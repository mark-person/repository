...
INSERT INTO `repo_knowledge_subject` (`subject_id`,`subject_name`,`subject_prio`,`subject_status`) VALUES (1,'必备小商品',1,1);
INSERT INTO `repo_knowledge_subject` (`subject_id`,`subject_name`,`subject_prio`,`subject_status`) VALUES (2,'国民商品',2,1);
